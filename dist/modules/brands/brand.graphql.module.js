...
const brand_resolver_1 = require("./graphql/brand.resolver");
...
BrandModule = __decorate([
    (0, common_1.Module)({
        controllers: [],
        providers: [
            brand_resolver_1.BrandResolver,
            index_1.BrandService,
            index_2.BrandRepository,
            {
                provide: brand_database_interface_1.IBrandDatabase,
                useClass: (0, database_resolver_1.ResolveDatabaseDependency)('BRAND'),
            },
        ],
    })
], BrandModule);
