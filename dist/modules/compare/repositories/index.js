...
exports.CompareRepository = void 0;
const common_1 = require("@nestjs/common");
const compare_db_interface_1 = require("./compare.db.interface");
let CompareRepository = class CompareRepository {
    constructor(db) {
        this.db = db;
    }
