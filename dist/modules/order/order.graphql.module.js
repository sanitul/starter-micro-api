...
const order_admin_resolver_1 = require("./graphql/order.admin.resolver");
const order_customer_resolver_1 = require("./graphql/order.customer.resolver");
...
OrderModule = __decorate([
    (0, common_1.Module)({
        controllers: [],
        providers: [
            order_customer_resolver_1.CustomerOrderResolver,
            order_admin_resolver_1.AdminOrderResolver,
